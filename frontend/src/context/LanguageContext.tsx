...
const messages = {
  en: {
    ...
    'auth.invalidPhoneTitle': 'Invalid phone number',
    'auth.invalidPhoneMessage': 'Please enter a valid phone number, for example 0900111222 or +84900111222.',
    ...
    'payment.eyebrow': 'Checkout',
    'payment.title': 'Secure Payment',
    'payment.copy': 'Scan the VietQR code and wait for payment confirmation from the backend before finishing checkout.',
    'payment.methodTitle': 'Payment Method',
    'payment.vietQrTitle': 'Scan VietQR to complete bank transfer',
    'payment.vietQrDetail': 'Scan the QR code with your banking app and use the exact transfer content shown below.',
    'payment.bank': 'Bank',
    'payment.account': 'Account',
    'payment.transferContent': 'Transfer content',
    'payment.loading': 'Loading',
    'payment.loadingData': 'Loading payment data from the backend.',
    'payment.dataMissing': 'Payment data could not be loaded yet.',
    'payment.completedLabel': 'I have transferred the exact VietQR amount.',
    'payment.confirmRequiredTitle': 'Payment confirmation required',
    'payment.confirmRequiredMessage': 'Please confirm that you have completed the VietQR transfer before continuing.',
    'payment.missingBookingTitle': 'Booking is missing',
    'payment.missingBookingMessage': 'Please create a booking before checking payment.',
    'payment.createFailedTitle': 'Could not create payment',
    'payment.createFailedMessage': 'Could not create VietQR payment.',
    'payment.checkFailedTitle': 'Could not check payment',
    'payment.checkFailedMessage': 'Could not verify whether the VietQR payment has been received.',
    'payment.notReceivedTitle': 'Payment not received',
    'payment.notReceivedMessage': 'The backend has not recorded this VietQR payment as successful yet.',
    'payment.receivedTitle': 'Payment received',
    'payment.receivedMessage': 'The backend has confirmed that this VietQR payment was received.',
    'payment.processing': 'Checking payment...',
    'payment.checkButton': 'Check Payment Status',
    'payment.loadingButton': 'Loading Payment',
    'payment.retryButton': 'Retry VietQR Payment',
    'payment.summaryButton': 'Confirm Payment',
  },
  vi: {
    ...
    'auth.invalidPhoneTitle': 'Số điện thoại không hợp lệ',
    'auth.invalidPhoneMessage': 'Vui lòng nhập số điện thoại hợp lệ, ví dụ 0900111222 hoặc +84900111222.',
    ...
    'payment.eyebrow': 'Thanh toán',
    'payment.title': 'Thanh toán an toàn',
    'payment.copy': 'Quét mã VietQR và chờ backend xác nhận đã nhận tiền trước khi hoàn tất.',
    'payment.methodTitle': 'Phương thức thanh toán',
    'payment.vietQrTitle': 'Quét VietQR để chuyển khoản',
    'payment.vietQrDetail': 'Dùng ứng dụng ngân hàng quét mã QR và nhập đúng nội dung chuyển khoản bên dưới.',
    'payment.bank': 'Ngân hàng',
    'payment.account': 'Tài khoản',
    'payment.transferContent': 'Nội dung chuyển khoản',
    'payment.loading': 'Đang tải',
    'payment.loadingData': 'Đang tải dữ liệu thanh toán từ backend.',
    'payment.dataMissing': 'Chưa tải được dữ liệu thanh toán.',
    'payment.completedLabel': 'Tôi đã chuyển khoản đúng số tiền VietQR.',
    'payment.confirmRequiredTitle': 'Cần xác nhận thanh toán',
    'payment.confirmRequiredMessage': 'Vui lòng xác nhận bạn đã hoàn tất chuyển khoản VietQR trước khi tiếp tục.',
    'payment.missingBookingTitle': 'Thiếu đặt phòng',
    'payment.missingBookingMessage': 'Vui lòng tạo đặt phòng trước khi kiểm tra thanh toán.',
    'payment.createFailedTitle': 'Không thể tạo thanh toán',
    'payment.createFailedMessage': 'Không thể tạo thanh toán VietQR.',
    'payment.checkFailedTitle': 'Không thể kiểm tra thanh toán',
    'payment.checkFailedMessage': 'Không thể xác minh backend đã nhận thanh toán VietQR hay chưa.',
    'payment.notReceivedTitle': 'Chưa ghi nhận thanh toán',
    'payment.notReceivedMessage': 'Backend chưa ghi nhận thanh toán VietQR này thành công.',
    'payment.receivedTitle': 'Đã nhận thanh toán',
    'payment.receivedMessage': 'Backend đã xác nhận đã nhận thanh toán VietQR này.',
    'payment.processing': 'Đang kiểm tra thanh toán...',
    'payment.checkButton': 'Kiểm tra thanh toán',
    'payment.loadingButton': 'Đang tải thanh toán',
    'payment.retryButton': 'Tạo lại VietQR',
    'payment.summaryButton': 'Xác nhận thanh toán',
  },
} as const
