...
const messages = {
  ...
  vi: {
    ...
    'footer.companyName': 'Công ty đặt phòng VIP Hospitality',
    'footer.supportNote': 'Hỗ trợ concierge và khách hàng 24/7',
    ...
    'contact.faq2': 'Concierge có thể sắp xếp đưa đón sân bay không?',
    ...
    'contact.successMessage': 'Gửi tin nhắn thành công. Concierge sẽ liên hệ bạn sớm.',
...
const routeTitlesByLanguage: Record<AppLanguage, Record<RouteKey, string>> = {
  ...
  vi: {
    ...
    adminBookings: 'Quản lý đặt phòng & thanh toán - VIP Booking',
    adminOperations: 'Vận hành khách sạn - VIP Booking',
    adminBilling: 'Quản lý hóa đơn - VIP Booking',
    adminPricing: 'Quản lý giá - VIP Booking',
